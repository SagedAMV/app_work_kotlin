...
android {
    ...
    defaultConfig {
        ...
        targetSdk = 34
        // 2.8.0: تنفيذ اختيارات جلسة «المواد والسحوبات والطوارئ» من
        // اختيارات.md — رقاقات الحالة الدلالية بدل مربعات المهام (2)،
        // العرض المحسوب للموجود ناقص المسحوبات (12)، وتبويب الطوارئ
        // العارض لسجل النزولات (21)
        versionCode = 12
        versionName = "2.8.0"
